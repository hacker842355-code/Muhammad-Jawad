...
const menuData = {
  pizzas: [
    { id: 'p1', name: 'Chicken Tikka', desc: 'Legends collection', prices: { Small: 650, Medium: 1300, Large: 1800 }, img: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
    { id: 'p2', name: 'BBQ Smokey', desc: 'Legends collection', prices: { Small: 650, Medium: 1300, Large: 1800 }, img: 'https://images.unsplash.com/photo-1604382355076-af4b0eb60143?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
    { id: 'p3', name: 'Cheese Lover', desc: 'Legends collection', prices: { Small: 650, Medium: 1300, Large: 1800 }, img: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
    { id: 'p4', name: 'Mughlai Tikka', desc: 'Ultimate collection', prices: { Small: 700, Medium: 1450, Large: 1900 }, img: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
    { id: 'p5', name: 'Afghan Tikka', desc: 'Ultimate collection', prices: { Small: 700, Medium: 1450, Large: 1900 }, img: 'https://images.unsplash.com/photo-1590947132387-155cc02f3212?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
    { id: 'p6', name: 'Malai Boti Pizza', desc: 'Ultimate collection', prices: { Small: 700, Medium: 1450, Large: 1900 }, img: 'https://images.unsplash.com/photo-1534308983496-4fabb1a015ee?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
    { id: 'p7', name: 'Chicken Cheese Stik', desc: 'Signature Pizza', prices: { Medium: 1700, Large: 2300 }, img: 'https://images.unsplash.com/photo-1541014741259-de529411b96a?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
    { id: 'p8', name: 'Crown Crust', desc: 'Signature Pizza', prices: { Medium: 1700, Large: 2300 }, img: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
    { id: 'p9', name: 'Lava Pizza', desc: 'Signature Pizza', prices: { Large: 2500 }, img: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' }
  ],
  starters: [
